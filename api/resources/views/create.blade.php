...
<main class="sm:container sm:mx-auto sm:mt-10">
    <div class="w-full flex justify-center sm:px-6">
      <section class="mb-10 flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
