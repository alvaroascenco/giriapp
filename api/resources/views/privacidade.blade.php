...
<section class="flex justify-center">
    <div class="w-3/4">
        <h1 class="text-3xl mb-2 text-center">Política de Privacidade</h1>
        <p class="mb-2">
        ...
        <p class="mb-2">
            ...
            O uso continuado de nosso site será considerado como aceitação de nossas práticas em torno de informações pessoais.
        ...
        O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o GiriAPI oferece no site e com caráter enunciativo, mas não limitativo:
        ...
        C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do GiriAPI, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.
        Mais informações
        Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso interaja com um dos recursos que você usa em nosso site.

        Esta política é efetiva a partir de 24 setembro 2022 11:47
    </div>
</section>
@endsection