...
<section class="flex justify-center">
    <div class="w-3/4 leading-6 mt-5">
        <h1 class="text-xl font-bold md:text-3xl mb-2 text-center">Política de Privacidade</h1>
        <p class="mb-2">
        ...
        <h1 class="text-xl font-bold md:text-3xl mb-2 text-center">Compromisso do Usuário</h1>

        O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o GiriAPI oferece no site e com caráter enunciativo, mas não limitativo:<br>
